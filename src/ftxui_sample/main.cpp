...
// configuration step. It creates a namespace called `nimba_vision`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", nimba_vision::cmake::project_name, nimba_vision::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", nimba_vision::cmake::project_version);
      return EXIT_SUCCESS;
    }
